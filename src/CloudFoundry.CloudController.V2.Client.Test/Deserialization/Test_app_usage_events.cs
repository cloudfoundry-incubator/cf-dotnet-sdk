  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""task_guid"": null
            ...
            Assert.AreEqual("ef312fa7-863d-49c5-9a6c-8b3aeddfb717", TestUtil.ToTestableString(page[0].EntityMetadata.Guid), true);
            ...
            Assert.AreEqual("ef312fa7-863d-49c5-9a6c-8b3aeddfb717", TestUtil.ToTestableString(page[0].AppGuid), true);
            Assert.AreEqual("name-1535", TestUtil.ToTestableString(page[0].AppName), true);
            Assert.AreEqual("ef312fa7-863d-49c5-9a6c-8b3aeddfb717", TestUtil.ToTestableString(page[0].SpaceGuid), true);
            Assert.AreEqual("name-1536", TestUtil.ToTestableString(page[0].SpaceName), true);
            Assert.AreEqual("ef312fa7-863d-49c5-9a6c-8b3aeddfb717", TestUtil.ToTestableString(page[0].OrgGuid), true);
            Assert.AreEqual("ef312fa7-863d-49c5-9a6c-8b3aeddfb717", TestUtil.ToTestableString(page[0].BuildpackGuid), true);
