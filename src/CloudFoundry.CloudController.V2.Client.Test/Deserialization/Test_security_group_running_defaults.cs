...
namespace CloudFoundry.CloudController.V2.Test.Deserialization
{
  ...
  ""resources"": [
    {
      ""metadata"": {
        ""guid"": ""32e222fb-1789-4519-9516-604a34956859"",
      ...
      ""entity"": {
        ...
        ""staging_default"": false
            ...
            Assert.AreEqual("32e222fb-1789-4519-9516-604a34956859", TestUtil.ToTestableString(page[0].EntityMetadata.Guid), true);
        ...
        public void TestSetSecurityGroupAsDefaultForRunningAppsResponse()
        {
            string json = @"{
  ""metadata"": {
    ""guid"": ""0f1babd0-0a2f-4c8d-8d1d-6bc4632d7ebd"",
  ...
  ""entity"": {
    ...
    ""staging_default"": false
            ...
            Assert.AreEqual("0f1babd0-0a2f-4c8d-8d1d-6bc4632d7ebd", TestUtil.ToTestableString(obj.EntityMetadata.Guid), true);
