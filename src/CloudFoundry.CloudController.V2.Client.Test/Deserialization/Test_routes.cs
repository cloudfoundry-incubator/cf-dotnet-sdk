  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""route_mappings_url"": ""/v2/routes/d8efb70e-4b07-4b43-a4e6-f9da3557512a/route_mappings""
            ...
            Assert.AreEqual("2f34960d-1550-4eb5-85c8-fe5736b0324f", TestUtil.ToTestableString(page[0].EntityMetadata.Guid), true);
            ...
            Assert.AreEqual("2f34960d-1550-4eb5-85c8-fe5736b0324f", TestUtil.ToTestableString(page[0].DomainGuid), true);
            Assert.AreEqual("2f34960d-1550-4eb5-85c8-fe5736b0324f", TestUtil.ToTestableString(page[0].SpaceGuid), true);
            Assert.AreEqual("2f34960d-1550-4eb5-85c8-fe5736b0324f", TestUtil.ToTestableString(page[0].ServiceInstanceGuid), true);
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""route_url"": ""/v2/routes/e1231176-c2af-437f-abbc-a861d8efc4e2""
            ...
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.PreviousUrl), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.NextUrl), true);
            Assert.AreEqual("fe529b73-0e40-416e-ad65-fbd771f31926", TestUtil.ToTestableString(page[0].EntityMetadata.Guid), true);
            ...
            Assert.AreEqual("fe529b73-0e40-416e-ad65-fbd771f31926", TestUtil.ToTestableString(page[0].AppGuid), true);
            Assert.AreEqual("fe529b73-0e40-416e-ad65-fbd771f31926", TestUtil.ToTestableString(page[0].RouteGuid), true);
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""route_mappings_url"": ""/v2/apps/429d2884-fb97-4399-aedc-fec5dd9bb282/route_mappings""
            ...
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.PreviousUrl), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.NextUrl), true);
            Assert.AreEqual("5a747018-6b1e-4cc2-89bd-754a4f2d9df2", TestUtil.ToTestableString(page[0].EntityMetadata.Guid), true);
            ...
            Assert.AreEqual("5a747018-6b1e-4cc2-89bd-754a4f2d9df2", TestUtil.ToTestableString(page[0].SpaceGuid), true);
            Assert.AreEqual("5a747018-6b1e-4cc2-89bd-754a4f2d9df2", TestUtil.ToTestableString(page[0].StackGuid), true);
